...
public class EconomyRushModified extends AbstractionLayerAI {
    ...
    public EconomyRushModified(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

    public EconomyRushModified(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    @Override
    public AI clone() {
        return new EconomyRushModified(utt, pf);
    }
    ...
    public void baseBehavior(Unit u, Player p, PhysicalGameState pgs) {
        ...
        for (Unit u2 : pgs.getUnits()) {
            if (u2.getType() == baseType
                ...
                nBases++;
                /**
                 * This is used later for building the barracks
                 */
                baseXpos = u2.getX()+1;
                baseYpos = u2.getY()+1;
            }
    ...
    public void barracksBehavior(Unit u, Player p, PhysicalGameState pgs) {
        ...
        /**
         * Changed numbers here to favour more light units
         */
    ...
    public void workersBehavior(List<Unit> workers, Player p, PhysicalGameState pgs, GameState gs) {
        ...
        if (nbarracks == 0 && !freeWorkers.isEmpty()) {
            ...
            if (p.getResources() >= barracksType.cost + resourcesUsed) {
                 ...
                 */
                buildIfNotAlreadyBuilding(u, barracksType,
                        baseXpos, baseYpos,
