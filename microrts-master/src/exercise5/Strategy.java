...
public class Strategy {
    ...
    private PlayerAction simpleBehaviour(int player, GameState gs, UnitTypeTable utt, PathFinding pf) {
        ...
        if (gs.canExecuteAnyAction(player)) {
            ...
            for (Unit u : gs.getUnits()) {
                ...
                if (u.getPlayer() == player && gs.getActionAssignment(u) == null && u != activeWorker && pa.getAction(u) == null) /*  Contents from TODO 6a */  {
                    ...
                    if ((u.getType().name.equals("Base") || u.getType().name.equals("Barracks")) && barracksExist)/*  Contents from TODO 6d */  { // Buildings
    ...
    public void handleAttack(GameState gs, PlayerAction pa, int playerID, PathFinding pf) {
        ...
        if (closestEnemy != null) {
            ...
            if (closestDistance <= activeWorker.getAttackRange()) /* TODO 4b: change this to True if the opponent is in attack range of the active worker (hint: look for a function in Unit)  */ {
